...
var Component = function Component(_ref) {
  ...
  }, /*#__PURE__*/React.createElement(_theme.ThemeConsumer, null, renderIcon(svg, props.colorType)));
};
...
var Outer = _theme.default.button(_templateObject(), Styles.rippleEffectMixin, Styles.buttonBaseMixin, function (props) {
  switch (props.colorType) {
    ...
    case 'secondary':
      return Styles.createCSSFromColorType(props.theme.colors.grayScale.S5, props.theme.colors.grayScale.S20, props.theme.colors.grayScale.S40, props.theme.colors.grayScale.S100, props.theme.colors.grayScale.S50);
