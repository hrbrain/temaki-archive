...
var Borderless = _interopRequireWildcard(require("./presentors/Borderless"));
...
var Component = React.memo(function (props) {
  ...
  var blurSearchValue = React.useCallback(function () {
    setSearchValue('');
  }, []);
  ...
  switch (props.type) {
    case 'borderless':
      return /*#__PURE__*/React.createElement(Borderless.Component, {
        items: props.items,
        value: props.value,
