...
var Component = React.memo(function (props) {
  return /*#__PURE__*/React.createElement(Outer, {
    ...
    size: "24px",
    color: 'white'
  }), props.text ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Label, null, props.label), /*#__PURE__*/React.createElement(Text, null, props.text)) : /*#__PURE__*/React.createElement(Label, null, props.label));
});
/**
 * Styles
 */
...
var Label = _theme.default.div(_templateObject3(), function (props) {
  return props.theme.colors.grayScale.S0;
});

var Text = _theme.default.div(_templateObject4(), function (props) {
  return props.theme.colors.grayScale.S0;
});